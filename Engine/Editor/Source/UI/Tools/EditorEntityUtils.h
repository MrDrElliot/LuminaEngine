...
namespace Lumina::EditorEntityUtils
{
    ...
    FFixedString MakeOutlinerDisplayName(const SNameComponent* Name, ECS::FEntity Entity, const char* Icon = LE_ICON_CUBE);
    ...
    void DrawEntityBounds(CWorld* World, ECS::FEntity Entity, const FVector4& Color, float Thickness = 3.0f, bool bDepthTest = true);
