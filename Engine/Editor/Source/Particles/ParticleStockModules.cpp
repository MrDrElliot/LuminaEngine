...
namespace Lumina
{
    ...
    {
        // Attributes are scalar-only, and these names are what the vertex shader resolves to slots.
        ...
        // Seeded at the END of the spawn chunk, or a newborn streaks back to the recycled slot's last owner.
        ...
        // An exponential chase, so the tail lags a fixed number of seconds whatever the frame rate.
